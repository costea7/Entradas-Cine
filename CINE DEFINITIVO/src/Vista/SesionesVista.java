...
public class SesionesVista extends JPanel{
   ...
   * 
   */   
  public void añadirSesion(Sesion sesion,boolean recibe_eventos_raton) throws FileNotFoundException {    
      ...
      if (recibe_eventos_raton) {
          ...
          @Override
            ...
            cineVista.notificacion(OyenteVista.Evento.VER_MAPA,sesion); 
