...
public class CineVista extends JFrame implements ActionListener, Observer {  
  ...
  private ImageIcon icono, iconoAsientoLibre, iconoAsientoOcupado;
  private JButton botonAbrir;
  
  private Cine cine;
      private JTextField display; //borra
  ...
  private void muestraInfoSesiones(JPanel panel){
   ...
   JLabel asientosTotales = new JLabel();
    JLabel asientosTotale1 = new JLabel();
   
   asientosLibres.setText("   Asientos libres: 15");
   asientosTotales.setText("Asientos totales: 240");
   
   //asientosLibres.setBorder(BorderFactory.createCompoundBorder(loweredbevel, raisedbevel));
   // asientosTotales.setBorder(BorderFactory.createCompoundBorder(loweredbevel, raisedbevel));
    
   
   panelInfo.add(asientosLibres);
   panelInfo.add(asientosTotales);
  
    panelInfo.add(asientosTotale1);
   ...
   * 
   */  
  public void ponerIconoCasilla(Asiento asiento, Casilla butaca) {
    
      if (butaca != Casilla.VACIA) {
      if (butaca == Casilla.LIBRE) {
         plateaVista.ponerIconoCasilla(asiento, iconoAsientoLibre);   
      } 
      else if (butaca == Casilla.OCUPADA) {
         plateaVista.ponerIconoCasilla(asiento, iconoAsientoOcupado);   
      }
    } else {
  ...
  public void añadirSesion(Sesion sesion) throws FileNotFoundException{
        sesionesVista.añadirSesion(sesion,SesionesVista.RECIBIR_EVENTOS_RATON);
     ...
     for (int fila = 0; fila < platea.devuelveNumFilas(); fila++) {
        ...
        for (int columna = 0; columna < platea.devuelveNumColumnas(); columna++) { 
          ...
          // if (platea.devuelveButaca(fila, columna) != Butaca.VACIA){
             ...
             ponerIconoCasilla(asiento, platea.devuelveEstadoCasilla(asiento));
        //   }     
        }     
     }  
  }
  ...
  public void update(Observable obj, Object arg) {
    ...
    if (arg instanceof Tupla) {
      tupla = (Tupla)arg;
      ponerIconoCasilla((Asiento)tupla.b, ((Casilla)tupla.a));
    } 
  }

    public void mensajeDialogo(String FICHERO_NO_ENCONTRADO) {
...
//
//    setSize(ancho-MARGEN_VERTICAL,alto-MARGEN_HORIZONTAL);
//    setResizable(false);
//     
//    //pack();  // ajusta ventana y sus componentes
//    setVisible(true);
