...
public class CineVista extends JFrame implements ActionListener, Observer {  
  ...
  private ImageIcon icono, iconoCruz;
  ...
  private static final String ICONO_APLICACION = "nueva.png";
   ...
   * 
   */
  private CineVista(final OyenteVista oyenteVista) throws FileNotFoundException {  
    super(TITULO);
    ...
    creaTablero(panelCentral, 10, 21);
    ...
    String a = "sesion1.txt";
    creaListaSesiones(panelEste, 1,a);
  ...
  public static synchronized CineVista instancia(
          OyenteVista oyenteIU) throws FileNotFoundException {
    if (instancia == null)
  ...
  private void creaListaSesiones(JPanel panelEste, int id, String fichero) throws FileNotFoundException{  
    sesionesVista = new SesionesVista(this, id,fichero,PlateaVista.RECIBIR_EVENTOS_RATON);
   ...
   * 
   */  
  public void ponerIconoCasilla(Asiento asiento) {
    
         plateaVista.ponerIconoCasilla(asiento, iconoCruz);   
      } 
  
  public void añadirSesion(int id, String fichero) throws FileNotFoundException{
        sesionesVista.añadirSesion(id, fichero);
  }
   ...
   * 
   */   
  public void iniciarTabledroVista(Platea platea) {
     Asiento asiento;
